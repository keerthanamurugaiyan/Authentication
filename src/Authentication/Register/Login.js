...
// import { registerUser } from '../Api/LoginApi'; // Adjusted to match the login functionality
...
//         if (validate()) {
//             try {
//                 const response = await registerUser({ email, password }); // Adjusted to match the login functionality
...
//                         <Link to={'/register'} className='mx-5'>Sign Up</Link> {/* Corrected to direct to the sign-up page */}
//                     </div>
//                 </form>
//             </div>
//         </Fragment>
